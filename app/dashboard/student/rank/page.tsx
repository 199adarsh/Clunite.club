          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="space-y-2 max-w-xl">
              <div className="flex items-center gap-2 flex-wrap">
                <Badge className="bg-indigo-50 text-indigo-700 border-indigo-200 text-xs font-bold uppercase tracking-wider shadow-sm">
                  Live Standings
                </Badge>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              <Button
                ...
                className="flex-1 sm:flex-initial rounded-xl border-slate-200 text-xs font-semibold h-9 text-slate-700 hover:bg-slate-50 flex items-center justify-center gap-1.5 bg-white/60 backdrop-blur-sm"
              >
                <Info className="h-4 w-4 text-indigo-600" />
                <span>Scoring Rules</span>
              </Button>
              <Link href="/dashboard/student" className="shrink-0">
                <Button variant="ghost" className="rounded-xl text-xs font-semibold h-9 text-slate-600 hover:bg-slate-100 bg-white/60 backdrop-blur-sm">
            ...
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-5 sm:gap-6 bg-white/50 backdrop-blur-md rounded-2xl p-5 border border-white/60 shadow-sm">
              ...
              <div className="flex items-center gap-2.5 shrink-0 pt-2 lg:pt-0">
                <Button
                  ...
                  className="flex-1 sm:flex-initial rounded-xl border-slate-200 text-slate-700 font-semibold text-xs h-9 hover:bg-slate-50 bg-white"
                >
                  Breakdown
                </Button>
                <Button
                  onClick={handleCopyShare}
                  className="flex-1 sm:flex-initial bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl font-semibold text-xs h-9 shadow-sm flex items-center justify-center gap-1.5 border-0"
                >
